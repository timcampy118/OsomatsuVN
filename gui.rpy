...
define gui.idle_color = '#58b2ff'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = '#3083e0'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = '#2f68a1'
...
define gui.insensitive_color = '#55557f'
...
define gui.text_color = '#0b1b7a'
define gui.interface_text_color = '#c6c6c6'
...
## bottom order.
define gui.namebox_borders = Borders(40, 30, 40, 30)
...
define gui.choice_button_width = 1020
define gui.choice_button_height = None
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(50, 35, 50, 35)
