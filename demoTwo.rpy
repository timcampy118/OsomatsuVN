label demoTwo:
    ...
    oso "(Everyone's ignoring me, huh.)"
    ...
    narrator "Choromatsu shifts his gaze farther up the beach, to an umbrella where the younger three brothers were gathered."
    ...
    show oso Swim 02 Neutral Fade Flip at pos2
    show kara Swim 01 Neutral at pos4
    kara "Ah, this is quite a comfortable rock."
    ...
    choro "Ah, fine... It'll give me a chance to read a bit of No Longer Human, anyway."
    hide kara
    hide choro
    show oso Swim 01 Neutral at pos4
    ...
    oso "(I can't believe I'm going through all this trouble just to get my brothers to play with me...)"
    show oso Swim 01 Angry3 at pos4
    oso "(This better be worth it.)"
    ...
    todo "AND HE WAS A PRO!!! THERE'S NO WAY I'M RIDING THAT!!!"
    hide jyushi
    hide ichi
    show kara Swim 03 Nervous at pos4
